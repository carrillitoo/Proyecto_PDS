...
public class MoverTarjetaUseCaseTest {
    ...
    void deberiaMoverTarjeta() throws LimiteListaExcedidoException {
        ...
        useCase.ejecutar("123e4567-e89b-12d3-a456-426614174001", tarjetaId.toString(), "Origen", "Destino");

        verify(mockTablero).moverTarjeta(tarjetaId, "Origen", "Destino");
