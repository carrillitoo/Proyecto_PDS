...
public class PermisosController {
    ...
    private void handleRoleChange(ActionEvent event) {
        ...
        try {
            ...
            if (roleEnum.equals("LECTOR"))
                roleEnum = "VIEWER";
            if (roleEnum.equals("EDITOR"))
                roleEnum = "GUEST"; // Asumiendo que es invitado/guest

            // TODO: In a real implementation, we would get the email of the selected user
            // from the UI row
